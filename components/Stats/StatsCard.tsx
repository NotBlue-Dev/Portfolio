...
export default function StatsCard({
  ...
  return (
    <motion.div
      className="flex-col justify-center py-4 origin-center transform bg-white border border-transparent rounded-md shadow select-none px-7 dark:bg-customLight dark:shadow-md hover:border-gray-400 dark:hover:border-neutral-600 group"
      variants={popUp}
    >
